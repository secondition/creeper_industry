package com.secondition.creeperindustry.client.production.biosphere;
...
public class BiosphereScreen extends AbstractContainerScreen<BiosphereMenu> {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(
                ...
                Component.translatable(
                        "gui.creeper_industry.biosphere.progress",
                        menu.progress(),
                        menu.requiredUnits()),
                8,
                56,
        ...
        guiGraphics.drawString(
                font,
                Component.translatable(
                        menu.structureSize() > 0
                                ? "gui.creeper_industry.biosphere.formed"
                                : "gui.creeper_industry.biosphere.unformed",
                        menu.structureSize()),
                8,
                22,
                0xD5D0C6,
                false);
        guiGraphics.drawString(
                font, playerInventoryTitle, inventoryLabelX, inventoryLabelY, 0xD5D0C6, false);
    }
    ...
    private Component getSelectionLine() {
        ...
        return Component.translatable(
                "gui.creeper_industry.biosphere.selected_output", preview.getHoverName());
    }
