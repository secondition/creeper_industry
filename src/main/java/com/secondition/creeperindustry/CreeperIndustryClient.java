...
public class CreeperIndustryClient {
    public CreeperIndustryClient(ModContainer container) {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        CreeperIndustry.LOGGER.info("HELLO FROM CLIENT SETUP");
        CreeperIndustry.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
