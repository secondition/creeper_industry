...
public class CIItems {
    ...
    public static final Supplier<Item> ZOOLOGICAL_BIOSPHERE = ITEMS.register("zoological_biosphere", () -> new BiosphereBlockItem(CIBlocks.ZOOLOGICAL_BIOSPHERE.get(), new Item.Properties()));
