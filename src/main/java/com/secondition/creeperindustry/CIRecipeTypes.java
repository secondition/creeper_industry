...
public class CIRecipeTypes {
    ...
    public static final Supplier<RecipeType<?>> BIOSPHERE_CULTIVATION = RECIPE_TYPES.register("biosphere_cultivation", () -> simple("biosphere_cultivation"));
    ...
    private static RecipeType<?> simple(String path) {
