...
public class CICreativeModeTabs {
    private static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, CreeperIndustry.MODID);
                            ...
                            CreativeModeTab.builder()
                                    .title(
                                            Component.translatable(
                                                    "itemGroup.creeper_industry.main"))
                                    ...
                                    .displayItems(
                                            (parameters, output) -> {
                                                ...
                                                output.accept(
                                                        CIItems.BLASTPROOF_DUCT_INTERFACE.get());
                                                ...
                                                output.accept(CIItems.WAVE_RECEIVER.get());
